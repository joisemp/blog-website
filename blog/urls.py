...
#from . import views
from.views import BlogHomeView, BlogDetailView, CreatePostView, UpdatePostView, DeletePostView, LandingPageView, CreateCategoryView, CategoryView, CategoryListView, LikeView
urlpatterns = [
